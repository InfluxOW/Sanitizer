...
class FloatTest extends TestCase
{
    ...
    public function dataForBeforeValidationCheck()
    {
        return array_filter($this->basicData(), function ($datum) {
            return in_array(Double::$slug, $datum['valid_after_normalization'], true);
        });
    }
    ...
    {
        return array_filter($this->basicData(), function ($datum) {
            return ! in_array(Double::$slug, array_merge($datum['valid_after_normalization'], $datum['already_valid']), true);
        });
    }
}
